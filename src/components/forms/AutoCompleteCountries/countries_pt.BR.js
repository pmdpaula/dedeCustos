export const countriesPtBR = [
  ...
  { code: 'CD', label: 'Congo, República do', phone: '242' },
  { code: 'CF', label: 'República Centro-Africana', phone: '236' },
  { code: 'CG', label: 'Congo, República Democrática do', phone: '243' },
  ...
  { code: 'CX', label: 'Ilha do Natal', phone: '61' },
  ...
  { code: 'FK', label: 'Ilhas Falkland (Malvinas)', phone: '500' },
  ...
  { code: 'IO', label: 'Território Britânico do Oceano Índico', phone: '246' },
  ...
  { code: 'KN', label: 'São Cristóvão e Neves', phone: '1-869' },
  {
    code: 'KP',
    label: 'Coréia, República Popular Democrática da',
    phone: '850',
  },
  { code: 'KR', label: 'Republica da Coréia', phone: '82' },
  { code: 'KW', label: 'Kuwait', phone: '965' },
  { code: 'KY', label: 'Ilhas Cayman', phone: '1-345' },
  { code: 'KZ', label: 'Cazaquistão', phone: '7' },
  { code: 'LA', label: 'Laos, República Democrática Popular do', phone: '856' },
  ...
  { code: 'MF', label: 'Saint Martin (parte francesa)', phone: '590' },
  ...
  { code: 'RE', label: 'Reunião, Ilha da', phone: '262' },
  ...
  // TODO continuar traducão dos países
